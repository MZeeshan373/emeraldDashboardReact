              ...
              <Card className=" shadow">
                ...
                <CardBody>
                  <Form>
                    ...
                    <FormGroup>
                      <Label for="EAddress">Ethereum Address</Label>
                      <Input
                        type="text"
                        name="e_address"
                        id="EAddress"
                    ...
                    <Row form>
                      ...
                      <Col md={6}>
                        <FormGroup>
                          ...
                          <Input type="text" name="postal-code" id="pc" placeholder="Postal Code" />
                        </FormGroup>
                      </Col>
                    </Row>
                    <FormGroup>
                    ...
                    <Button type={process} onClick={e => e.preventDefault}>Submit</Button>
                  </Form>
                </CardBody>
              </Card>
            </div>
